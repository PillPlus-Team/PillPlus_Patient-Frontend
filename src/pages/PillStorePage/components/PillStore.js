    ...
    return (
        ...
        >
            <div className='flex flex-col w-80 mx-2 flex-grow '>
                ...
                <h3 className='text-gray-400 line-clamp-3 sm:line-clamp-2 group-hover:text-gray-400 group-focus:text-gray-300'>{pillStore.location}</h3>
            </div>
            
            
            <h3 className={
                    `${pillStore.status ?'bg-green-100 text-green-500 group-focus:bg-green-500 group-focus:text-white':'bg-red-200 text-red-500'} 
